-file("megaco_text_mini_parser.yrl", 0).
-module(megaco_text_mini_parser).
-file("megaco_text_mini_parser.erl", 3).
...
-file("/mydisk/erlang/bootstrap/lib/parsetools/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
-file("megaco_text_mini_parser.erl", 199).
...
-file("megaco_text_mini_parser.yrl", 397).
