...
-asn1_info([{vsn,'5.2.2'},
            {module,'OTP-PUB-KEY'},
            {options,[{i,"/mydisk/erlang/lib/public_key/asn1/../src"},
 warnings,ber,errors,
 {cwd,"/mydisk/erlang/lib/public_key/asn1"},
 {outdir,"/mydisk/erlang/lib/public_key/asn1/../src"},
 der,noobj,asn1config,
 {i,"."},
 {i,"/mydisk/erlang/lib/public_key/asn1"}]}]).
